...
class DropratesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create droprate" do
    assert_difference("Droprate.count") do
      post droprates_url, params: { droprate: { boss_kills: @droprate.boss_kills, drop_chance: @droprate.drop_chance, item_name: @droprate.item_name, kills_per_drop: @droprate.kills_per_drop, number_of_drops: @droprate.number_of_drops } }
    end
  ...
  test "should update droprate" do
    patch droprate_url(@droprate), params: { droprate: { boss_kills: @droprate.boss_kills, drop_chance: @droprate.drop_chance, item_name: @droprate.item_name, kills_per_drop: @droprate.kills_per_drop, number_of_drops: @droprate.number_of_drops } }
